---
title: "Patterns of Environmental Justice In Los Angeles California"
format: html
editor: visual
...
```{r}
# Check to make sure it worked and that all three now match and create warning message if they do not
...
# create a table of the percent_holc data with a kable
...
Next, with the bird data and HOLC blocs joined, we may find percentages for analysis and visualization.
